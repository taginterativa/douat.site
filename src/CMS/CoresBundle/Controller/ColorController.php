...
class ColorController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $num_rows = count($em->getRepository('CMSCoresBundle:Color')->findAll());
        $entities = $em->getRepository('CMSCoresBundle:Color')->findBy(array(),array(),10);
    ...
    public function paginateAction($page)
    {
        $em       = $this->getDoctrine()->getManager();
        $num_rows = count($em->getRepository('CMSCoresBundle:Color')->findAll());
        $entities = $em->getRepository('CMSCoresBundle:Color')->findBy(array(),array(),10, ($page-1)*10);
