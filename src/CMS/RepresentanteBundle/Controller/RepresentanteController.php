...
class RepresentanteController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $num_rows = count($em->getRepository('CMSRepresentanteBundle:Representante')->findAll());
        $entities = $em->getRepository('CMSRepresentanteBundle:Representante')->findBy(array(),array(),10);
    ...
    public function paginateAction($page)
    {
        $em       = $this->getDoctrine()->getManager();
        $num_rows = count($em->getRepository('CMSRepresentanteBundle:Representante')->findAll());
        $entities = $em->getRepository('CMSRepresentanteBundle:Representante')->findBy(array(),array(),10, ($page-1)*10);
